...
import { braces, green_left, green_right, yoga } from '../../assets/images/images';
...
<>
     ...
     <img src={
    green_left} alt="shadow" className='right-shadow'/>
            <div className='search-container'>
                    <div className='row'>
                    <div className='col-lg-2 border-line'>
                        <input type='search' placeholder='Ayurvedic/Dental ' className='select_tag'/>
                    </div>
                    <div className='col-lg-2 border-line'>
                    ...
                    <div className='col-lg-2 border-line'> <select name="Date" id="Date" className='select_tag'>
        ...
        <div className='col-lg-12'>
           <div className="row appointement-booking">
                ...
                <div className='book-container'>
                    <button className='Book-Appoinment-btn'>Book Appoinment</button>
                </div>
